...
var d3vCode = {
	...
	/**
	 * @description Toggles code call chat gpt 
	 **/
	toggleChatGPT :function(){
	...
	sendMessage  : function() {
		//const apiKey = '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';
			...
			fetch("https://api.openai.com/v1/chat/completions",{
				...
				headers: {
					...
					Authorization: "Bearer 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",
				},
				body: JSON.stringify({
					model: "gpt-3.5-turbo",
					messages: [
	 ...
	 showHistory : function(message,response){
	...
	goToCodeDefaultState : function() {
	    ...
	    $(document).attr('title', 'ChatGPTSFDC');
